...
func NewQueryUserLogic(ctx context.Context, svcCtx *svc.ServiceContext, r *http.Request) *QueryUserLogic {
...
func (l *QueryUserLogic) QueryUser(req *types.QueryUserReq) (resp *types.QueryUserResp, err error) {
	...
	// 分页查询动态
	dynamics, err := l.svcCtx.DynamicRpc.QueryUser(l.ctx, &dynamic.QueryUserReq{
		UserId:  req.UserId,
		LastId:  req.LastId,
		PageNum: req.PageNum,
	})
	...
	return &types.QueryUserResp{List: result}, nil
}
