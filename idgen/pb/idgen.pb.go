...
func (x *IdGenResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdGenResp) ProtoMessage() {}

func (x *IdGenResp) ProtoReflect() protoreflect.Message {
	mi := &file_idgen_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdGenResp.ProtoReflect.Descriptor instead.
func (*IdGenResp) Descriptor() ([]byte, []int) {
	return file_idgen_proto_rawDescGZIP(), []int{1}
}

func (x *IdGenResp) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_idgen_proto_rawDesc = []byte{
	...
	0x64, 0x67, 0x65, 0x6e, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x1b, 0x0a,
	0x09, 0x49, 0x64, 0x47, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x36, 0x0a, 0x05, 0x49, 0x64,
	0x47, 0x65, 0x6e, 0x12, 0x2d, 0x0a, 0x0b, 0x49, 0x64, 0x47, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x12, 0x0c, 0x2e, 0x69, 0x64, 0x67, 0x65, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x1a, 0x10, 0x2e, 0x69, 0x64, 0x67, 0x65, 0x6e, 0x2e, 0x49, 0x64, 0x47, 0x65, 0x6e, 0x52, 0x65,
...
var file_idgen_proto_goTypes = []interface{}{
	(*Empty)(nil),     // 0: idgen.Empty
	(*IdGenResp)(nil), // 1: idgen.IdGenResp
}
var file_idgen_proto_depIdxs = []int32{
	0, // 0: idgen.IdGen.IdGenServer:input_type -> idgen.Empty
	1, // 1: idgen.IdGen.IdGenServer:output_type -> idgen.IdGenResp
